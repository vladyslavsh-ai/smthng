(function () {
  ...
  const CIRCLE_IMAGES = {
    PREV: 'https://r7casino-wordpress-prod.s3.amazonaws.com/uploads/2025/11/circle-prev-day.png',
    CURRENT: 'https://r7casino-wordpress-prod.s3.amazonaws.com/uploads/2025/11/circle-current-day.png',
    FUTURE: 'https://r7casino-wordpress-prod.s3.amazonaws.com/uploads/2025/11/circle-future-day.png',
    LAST: 'https://r7casino-wordpress-prod.s3.amazonaws.com/uploads/2025/11/circle-last-day.png',
  }; 
  ...
  const totalCalendarDays = new Date(now.getFullYear(), now.getMonth() + 1, 0).getDate();
